// Minimal, monoline icon set — Lucide-esque, 1.5px stroke
// Size defaults to 16px.
...
const Icons = {
  ...
  Comment: (p) => <Icon {...p}><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></Icon>,
  ...
  Chevron: (p) => <Icon {...p}><polyline points="9 18 15 12 9 6"/></Icon>,
  ...
  Sort: (p) => <Icon {...p}><path d="M11 5h10"/><path d="M11 9h7"/><path d="M11 13h4"/><path d="M3 17l3 3 3-3"/><path d="M6 18V4"/></Icon>,
  ...
  Sparkles: (p) => <Icon {...p}><path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9z"/><path d="M19 17l.7 1.9L22 20l-2.3.7L19 23l-.7-2.3L16 20l2.3-1z"/></Icon>,
  ...
  Pencil: (p) => <Icon {...p}><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></Icon>,
  History: (p) => <Icon {...p}><path d="M1 4v6h6"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/><polyline points="12 7 12 12 15 13.5"/></Icon>,
  Kanban: (p) => <Icon {...p}><rect x="3" y="3" width="6" height="14"/><rect x="11" y="3" width="6" height="9"/><rect x="19" y="3" width="2" height="17" style={{display:'none'}}/><rect x="3" y="3" width="6" height="17"/><rect x="11" y="3" width="6" height="10"/><rect x="19" y="3" width="2" height="7"/></Icon>,
  ...
  Reports: (p) => <Icon {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></Icon>,
  At: (p) => <Icon {...p}><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"/></Icon>,
};
