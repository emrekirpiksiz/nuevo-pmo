...
namespace Nuevo.PMO.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260421053204_DraftPublishModel")]
    partial class DraftPublishModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nuevo.PMO.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<string>("AddressedBlockText")
                        .HasMaxLength(4096)
                        .HasColumnType("character varying(4096)");

                    b.Property<Guid?>("AddressedBy")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AddressedInVersionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AddressedInVersionId");
            ...
            modelBuilder.Entity("Nuevo.PMO.Domain.Entities.Comment", b =>
                {
                    b.HasOne("Nuevo.PMO.Domain.Entities.DocumentVersion", "AddressedInVersion")
                        .WithMany()
                        .HasForeignKey("AddressedInVersionId")
                    ...
                    b.Navigation("AddressedInVersion");
